...
test('Alpha_E2E_001: Verify that the New user is able to Sign Up, Log In, and Navigate to the Home Page Successfully', async () => {
    ...
    await page1.locator(locators['SVG_1'], { description: descriptions['SVG_1'] }).click({ force: true });
    ...
    await expect(page1.locator(locators['H2 with Text Sign In'], { description: descriptions['H2 with Text Sign In'] })).toHaveText(`Sign In`);
...
// Auto generated test case
test('Alpha_E2E_009: Verify that a User Can Add an Item to Wishlist, Then Move It to Cart and Checkout', async () => {
    // Setup and Login
    const page1 = await context.newPage();
    await page1.goto('http://demo.alphabin.co');
    await abPlaywright.setupLogging(page1);
    ...
    // Navigate to Shop and Add Item to Wishlist
    await page1.locator(locators['Button with Text Shop Now'], { description: descriptions['Button with Text Shop Now'] }).click({ force: true });
    await page1.locator(locators['SVG Path inside SVG_8'], { description: descriptions['SVG Path inside SVG_8'] }).click({ force: true });
    await page1.locator(locators['SVG Path inside SVG_4'], { description: descriptions['SVG Path inside SVG_4'] }).click({ force: true });
    await page1.locator(locators['SVG Path inside SVG_6'], { description: descriptions['SVG Path inside SVG_6'] }).click({ force: true });
    await page1.locator(locators['SVG_3'], { description: descriptions['SVG_3'] }).click({ force: true });
   ...
   // await expect(page1.locator(locators['Div with role status'], { description: descriptions['Div with role status'] })).toBeVisible();
    ...
    // Proceed to Checkout
    await page1.locator(locators['Html inside body_26'], { description: descriptions['Html inside body_26'] }).click({ force: true });
    await expect(page1.locator(locators['Html inside body_2'], { description: descriptions['Html inside body_2'] })).toBeVisible();
    await page1.mouse.wheel(1, 261);
    await page1.mouse.wheel(1, 4);
    await page1.locator(locators['Button with Text Checkout'], { description: descriptions['Button with Text Checkout'] }).click({ force: true });
    await page1.mouse.wheel(1, -264);
    await expect(page1.locator(locators['Html inside body_2'], { description: descriptions['Html inside body_2'] })).toBeVisible();
...
test('Alpha_E2E_011: Verify that the User Can Add a Product to Cart Before Login and Complete the Order After Logging In', async () => {
    ...
    await page1.mouse.wheel(1, 4);
    await page1.locator(locators['SVG Path inside SVG_7'], { description: descriptions['SVG Path inside SVG_7'] }).click({ force: true });
    await page1.locator(locators['SVG Path inside SVG_11'], { description: descriptions['SVG Path inside SVG_11'] }).click({ force: true });
    await page1.mouse.wheel(1, -302);
    await page1.locator(locators['Html inside body_16'], { description: descriptions['Html inside body_16'] }).click({ force: true });
    await page1.mouse.wheel(1, 79);
    await page1.mouse.wheel(1, 274);

    // Interact with product details
    await page1.locator(locators['Button with Text Additional information'], { description: descriptions['Button with Text Additional information'] }).click({ force: true });
    await page1.mouse.wheel(1, 234);
    await page1.locator(locators['Button with Text Reviews'], { description: descriptions['Button with Text Reviews'] }).click({ force: true });
    await page1.mouse.wheel(1, -586);
    ...
    await expect(page1.locator(locators['H1 with Text Shopping Cart'], { description: descriptions['H1 with Text Shopping Cart'] })).toHaveText(`Shopping Cart`);
    await expect(page1.locator(locators['Html inside body_2'], { description: descriptions['Html inside body_2'] })).toBeVisible();
    await page1.mouse.wheel(1, 532);
    await page1.mouse.wheel(1, -504);
    await page1.mouse.wheel(1, 143);

    // Proceed to checkout
    await page1.locator(locators['Button with Text Checkout'], { description: descriptions['Button with Text Checkout'] }).click({ force: true });
    await page1.mouse.wheel(1, -170);
    await expect(page1.locator(locators['Html inside body_17'], { description: descriptions['Html inside body_17'] })).toBeVisible();
    ...
    await page1.locator(locators['Input with name password'], { description: descriptions['Input with name password'] }).press(`Enter`);
    await expect(page1.locator(locators['Div with role status'], { description: descriptions['Div with role status'] })).toBeVisible();
    await page1.locator(locators['SVG_5'], { description: descriptions['SVG_5'] }).click({ force: true });
    await expect(page1.locator(locators['Html inside body_18'], { description: descriptions['Html inside body_18'] })).toBeVisible();

    // Complete 
    await page1.locator(locators['Button with Text View Cart'], { description: descriptions['Button with Text View Cart'] }).click({ force: true });
    await page1.mouse.wheel(1, 484);
    await page1.locator(locators['Span with Text Checkout'], { description: descriptions['Span with Text Checkout'] }).click({ force: true });
    await page1.mouse.wheel(1, -483);
    await expect(page1.locator(locators['Html inside body_19'], { description: descriptions['Html inside body_19'] })).toBeVisible();
    await page1.locator(locators['Button with Text Cash on Delivery'], { description: descriptions['Button with Text Cash on Delivery'] }).click({ force: true });
    await page1.waitForTimeout(2000);
    await page1.mouse.wheel(1, 52);
    await page1.locator(locators['Button with Text Place Order'], { description: descriptions['Button with Text Place Order'] }).click({ force: true });
    await page1.mouse.wheel(1, -51);
    await expect(page1.locator(locators['Html inside body_6'], { description: descriptions['Html inside body_6'] })).toBeVisible();
    await page1.mouse.wheel(1, 419);
    await expect(page1.locator(locators['H3 with Text Your order is confirmed'], { description: descriptions['H3 with Text Your order is confirmed'] })).toHaveText(`Your order is confirmed`);
